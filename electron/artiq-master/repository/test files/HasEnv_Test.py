...
# '''
# This dummy test version 3 (see version 1&2 down below) could let user to use the gui to update the dataset and set dac voltages after click on set voltages button
# '''
...
class Dummy_Test(DummyEnv, EnvExperiment):#, object):
    def build(self):
        DummyEnv.build(self)
        # self.setattr_device('core')
        # self.setattr_device('zotino0')
...
# '''
# This dummy test version 2 (see version 1 down below) could let user to open the gui and update the dataset and dac voltages after click on set voltages in gui and exit
# '''
# class DummyEnv(HasEnvironment):
#     def build(self):
#         self.setattr_device('core')
...
#         print("test run")
#         # for i in range(21):
#             # self.mutate_dataset(key="dac_voltages", index=i, value=i/10+1)
...
# '''
# This dummy test version 1 could set dataset in hasenvironment and get dataset and update the DAC voltages in the main experiment
# '''
