...
class Electron(HasEnvironment):
    ...
    def pulse_counting(self,time_count,detection_time):
        # self.set_dataset('count_tot',[-100]*time_count,broadcast=True) # Number of pulses sent to ttl2
        self.core.reset()
        ...
        while True:
            ...
            for j in range(time_count):
                ...
                self.mutate_dataset('count_tot',j,self.ttl2.count(t_count)/(detection_time*ms))
    ...
    def threshold_detector_test(self,trigger_level,number_of_datapoints,number_of_repetitions,t_load,t_wait,t_delay,time_window_width): # zotino4 for trigger, zotino 6 give 3.3 V
        ...
        self.zotino0.init()
        delay(500*us)
        self.zotino0.write_dac(4,trigger_level)
...
class MyTabWidget(HasEnvironment,QWidget):
    ...
    def setup_UI(self):
        ...
        self.tabs.addTab(self.tab3, "Main Experiment")
...
# artiq.master.scheduler:got worker exception in prepare stage, deleting RID 1177
# artiq.master.worker:worker exception details
# Traceback (most recent call last):
#   File "/nix/store/z1nq1mxxra1c1xhp2y20j5zrh1687mls-python3-3.8.8-env/lib/python3.8/site-packages/artiq/master/scheduler.py", line 218, in _do
#     await run.prepare()
#   File "/nix/store/z1nq1mxxra1c1xhp2y20j5zrh1687mls-python3-3.8.8-env/lib/python3.8/site-packages/artiq/master/scheduler.py", line 34, in worker_method
#     return await m(*args, **kwargs)
#   File "/nix/store/z1nq1mxxra1c1xhp2y20j5zrh1687mls-python3-3.8.8-env/lib/python3.8/site-packages/artiq/master/worker.py", line 275, in prepare
#     await self._worker_action({"action": "prepare"})
#   File "/nix/store/z1nq1mxxra1c1xhp2y20j5zrh1687mls-python3-3.8.8-env/lib/python3.8/site-packages/artiq/master/worker.py", line 252, in _worker_action
#     completed = await self._handle_worker_requests()
#   File "/nix/store/z1nq1mxxra1c1xhp2y20j5zrh1687mls-python3-3.8.8-env/lib/python3.8/site-packages/artiq/master/worker.py", line 208, in _handle_worker_requests
#     obj = await self._recv(self.watchdog_time())
#   File "/nix/store/z1nq1mxxra1c1xhp2y20j5zrh1687mls-python3-3.8.8-env/lib/python3.8/site-packages/artiq/master/worker.py", line 193, in _recv
#     raise WorkerError(
# artiq.master.worker.WorkerError: Worker ended while attempting to receive data (RID 1177)


# artiq.master.scheduler:got worker exception in run stage, deleting RID 1178
# artiq.master.worker:worker exception details
# Traceback (most recent call last):
#   File "/nix/store/z1nq1mxxra1c1xhp2y20j5zrh1687mls-python3-3.8.8-env/lib/python3.8/site-packages/artiq/master/scheduler.py", line 268, in _do
#     completed = await run.run()
#   File "/nix/store/z1nq1mxxra1c1xhp2y20j5zrh1687mls-python3-3.8.8-env/lib/python3.8/site-packages/artiq/master/scheduler.py", line 34, in worker_method
#     return await m(*args, **kwargs)
#   File "/nix/store/z1nq1mxxra1c1xhp2y20j5zrh1687mls-python3-3.8.8-env/lib/python3.8/site-packages/artiq/master/worker.py", line 278, in run
...
#   File "/nix/store/z1nq1mxxra1c1xhp2y20j5zrh1687mls-python3-3.8.8-env/lib/python3.8/site-packages/artiq/master/worker.py", line 193, in _recv
#     raise WorkerError(
# artiq.master.worker.WorkerError: Worker ended while attempting to receive data (RID 1178)